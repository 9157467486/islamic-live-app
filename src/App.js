...
// ─── 🔑 MASTER RECOVERY PASSWORD — use this if any masjid admin forgets their password
  ...
  return (
    <div style={{ padding:"20px 20px 80px" }}>
      ...
      <div onClick={() => setOpen(true)} style={{
        ...
        borderRadius:18, padding:"22px 20px", textAlign:"center", cursor:"pointer",
...
function QuranPage() {
  ...
  return (
    <div style={{ padding:"20px 20px 80px" }}>
      ...
      <div style={{ color:"rgba(255,255,255,0.45)", fontSize:13, marginBottom:24 }}>Full Quran PDF — read anytime</div>
      ...
      <div onClick={() => setOpen(true)} style={{
        ...
        boxShadow:"0 8px 32px rgba(0,0,0,0.4)", marginBottom:20,
      }}>
        <div style={{ fontSize:56, marginBottom:12 }}>📖</div>
        <div style={{ color:LIGHT_GOLD, fontSize:22, fontWeight:700, fontFamily:"'Playfair Display',serif", marginBottom:6 }}>Al-Quran Al-Kareem</div>
        <div style={{ color:"rgba(255,255,255,0.5)", fontSize:13, marginBottom:16 }}>Complete Quran PDF</div>
        <div style={{ background:`linear-gradient(135deg,${GOLD},${LIGHT_GOLD})`, color:DARK_GREEN, borderRadius:20, padding:"10px 28px", fontSize:14, fontWeight:700, display:"inline-block" }}>
          Open Quran →
        </div>
      </div>
